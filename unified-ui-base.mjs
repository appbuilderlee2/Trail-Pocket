...
async function checkAppUpdate(){
 ...
 try{
  ...
  }else status.textContent=`已是最新版本 · v4.1.8 · ${new Date().toLocaleTimeString([], {hour:'2-digit',minute:'2-digit'})}`;
...
export function setupUnifiedUI(ctx) {
 document.querySelector('.header-status .version').textContent='v4.1.8';
 const settingsEyebrow=document.querySelector('#settingsView>.eyebrow');if(settingsEyebrow)settingsEyebrow.textContent='TRAIL POCKET · V4.1.8';
