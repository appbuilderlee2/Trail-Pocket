...
- 「選擇離線範圍」使用中央紫框（畫面各邊內縮 15%），拖動／縮放調整範圍，顯示面積與座標。命名後下載框內道路、步道、水域及林地向量資料；範圍過大會要求放大。每區最多 150 km²、32 MB，150 秒逾時。
...
- 逐條下載、一次一項，避免大量預載公共服務。每個範圍 150 km² 上限，回傳資料最多 32 MB，150 秒整體逾時。超長路線請分段匯入。
