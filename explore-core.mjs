...
export function validateArea(b){if(!b||!Object.values(b).every(Number.isFinite)||b.west>=b.east||b.south>=b.north||b.west< -180||b.east>180||b.south< -85||b.north>85)throw Error('所選範圍無效，請移到地圖內。');const size=areaKm2(b);if(size>150)throw Error('範圍超過 150 km²，請放大地圖再選取。');if(size<.001)throw Error('範圍太細，請縮小地圖少少。');return size;}
