const layersFor = source => [
  ...
  {id:`${source}-poi-label`,type:'symbol',source,'source-layer':'poi',minzoom:15,filter:['has','name'],layout:{'text-field':['coalesce',['get','name:zh'],['get','name:en'],['get','name']],'text-size':['interpolate',['linear'],['zoom'],15,10,18,12],'text-padding':4,'text-optional':false},paint:{'text-color':'#344239','text-halo-color':'#f7f8f1','text-halo-width':1.2}},
